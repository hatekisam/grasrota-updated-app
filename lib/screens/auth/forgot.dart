    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  InkWell(
                      ...
                      onTap: () async {
                        ...
                        //   dynamic result =
                        //       await _auth.ForgotWithEmailAndPassword(
          ...
          //         textScaleFactor: 1.0,
          //       ),
          //       child: ForgotButton(Buttons.Google, text: "Logg inn med Google",
          //           onPressed: () async {
          //         setState(() => loading = true);
          //         StoredData.choosenOrg = "";
          //         StoredData.adminOrg = "";
          //         StoredData.isAdmin = false;
          //         dynamic result = await _auth.ForgotWithGoogle();
          //         print(result);
          ...
          //         textScaleFactor: 1.0,
          //       ),
          //       child: ForgotButton(Buttons.Apple, text: "Logg inn med Apple",
          //           onPressed: () async {
          //         setState(() => loading = true);
          //         StoredData.choosenOrg = "";
          //         StoredData.adminOrg = "";
          //         StoredData.isAdmin = false;
          //         dynamic result = await _auth.ForgotWithApple();
          //         if (result == null) {
          //           setState(() {
          //             error = "noe gikk galt";
          //             loading = false;
