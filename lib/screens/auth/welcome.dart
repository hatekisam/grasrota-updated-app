    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  InkWell(
                      ...
                      onTap: () async {
                        ...
                        //   dynamic result =
                        //       await _auth.WelcomeWithEmailAndPassword(
          ...
          //         textScaleFactor: 1.0,
          //       ),
          //       child: WelcomeButton(Buttons.Google, text: "Logg inn med Google",
          //           onPressed: () async {
          //         setState(() => loading = true);
          //         StoredData.choosenOrg = "";
          //         StoredData.adminOrg = "";
          //         StoredData.isAdmin = false;
          //         dynamic result = await _auth.WelcomeWithGoogle();
          //         print(result);
          ...
          //         textScaleFactor: 1.0,
          //       ),
          //       child: WelcomeButton(Buttons.Apple, text: "Logg inn med Apple",
          //           onPressed: () async {
          //         setState(() => loading = true);
          //         StoredData.choosenOrg = "";
          //         StoredData.adminOrg = "";
          //         StoredData.isAdmin = false;
          //         dynamic result = await _auth.WelcomeWithApple();
          //         if (result == null) {
          //           setState(() {
          //             error = "noe gikk galt";
          //             loading = false;
